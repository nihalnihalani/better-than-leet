...
- **Gemini 3.1 Pro** for deep reasoning, code analysis, and real-time voice interviews.
...
- **🗣️ Conversational AI Interviewer**: Powered by Gemini Live API with native audio, the agent speaks naturally, asks follow-up questions, and responds to the candidate's actions.
...
- **🧠 Advanced Reasoning Engine**:
  ...
  - **AI Analysis**: Uses Gemini 3.1 Pro to understand code logic and generate "Senior Engineer" level feedback.
...
sequenceDiagram
    ...
    participant V as Voice (Gemini Live API)
...
| **AI & Voice** | **Gemini 3.1 Pro + Live API** | <img src="public/icons/gemini.png" width="48" alt="Gemini" /> |
