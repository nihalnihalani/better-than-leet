...
export const SYSTEM_DESIGN_TOPICS: SystemDesignTopic[] = [
  ...
  },
  {
    ...
    description: 'Design a ride-sharing platform like Uber/Lyft with real-time driver-rider matching, live location tracking, and dynamic surge pricing.',
    difficulty: 'Hard',
    expectedComponents: ['client', 'loadbalancer', 'service', 'database', 'cache', 'queue', 'worker', 'storage'],
    discussionPoints: [
      'Real-time driver-rider matching algorithms and geospatial indexing',
      'Live location tracking with WebSockets and GPS updates',
      'Surge pricing engine based on supply/demand signals',
      'Trip lifecycle management and state machines',
      'ETA computation and route optimization',
    ],
  },
  {
    id: 'ecommerce-platform',
    title: 'E-Commerce Platform',
    description: 'Design an e-commerce platform like Amazon with product catalog, shopping cart, checkout flow, and inventory management.',
    difficulty: 'Hard',
    expectedComponents: ['client', 'loadbalancer', 'service', 'database', 'cache', 'queue', 'worker', 'cdn', 'storage'],
    discussionPoints: [
      'Product catalog service with search and filtering',
      'Shopping cart with session management and persistence',
      'Checkout and payment processing with idempotency',
      'Inventory management and stock reservation',
      'Order fulfillment pipeline and status tracking',
    ],
  },
  {
    id: 'distributed-kv-store',
    title: 'Distributed Key-Value Store',
    description: 'Design a distributed key-value store like Redis or DynamoDB with data partitioning, replication, and consistency guarantees.',
    difficulty: 'Hard',
    expectedComponents: ['client', 'service', 'database', 'cache', 'worker', 'queue'],
    discussionPoints: [
      ...
      'Failure detection with gossip protocol and heartbeats',
      'Data compaction, TTL expiry, and memory management',
    ],
  },
  {
    id: 'booking-system',
    title: 'Booking System',
    description: 'Design a hotel or flight booking system with real-time availability search, reservation management, and payment processing.',
    difficulty: 'Medium',
    expectedComponents: ['client', 'loadbalancer', 'service', 'database', 'cache', 'queue', 'worker'],
    discussionPoints: [
      'Availability search with date range queries and filtering',
      'Reservation locking to prevent double-booking',
      'Payment processing and refund workflows',
      'Overbooking strategies and waitlist management',
      'Notification pipeline for confirmations and reminders',
    ],
  },
  {
    id: 'social-media-stories',
    title: 'Social Media Stories',
    description: 'Design an ephemeral content system like Instagram Stories with 24-hour expiry, viewer tracking, and real-time updates.',
    difficulty: 'Medium',
    expectedComponents: ['client', 'loadbalancer', 'service', 'database', 'cache', 'cdn', 'storage', 'queue'],
    discussionPoints: [
      'Ephemeral content storage with automatic TTL-based expiry',
      'Story feed aggregation from followed users',
      'Viewer tracking and analytics collection',
      'Media upload pipeline with transcoding and CDN distribution',
      'Real-time story updates and push notifications',
    ],
  },
  {
    id: 'collaborative-editor',
    title: 'Real-Time Collaborative Editor',
    description: 'Design a collaborative document editor like Google Docs with real-time multi-user editing, conflict resolution using OT/CRDT, and presence awareness.',
    difficulty: 'Hard',
    expectedComponents: ['client', 'loadbalancer', 'service', 'database', 'cache', 'queue', 'storage'],
    discussionPoints: [
      'Operational Transformation vs CRDT for conflict resolution',
      'Real-time synchronization with WebSocket connections',
      'User presence and cursor position broadcasting',
      'Document versioning, undo/redo, and revision history',
