...
export default function Home() {
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col selection:bg-sky-200 selection:text-foreground dark:selection:bg-purple-900/50">
      ...
      <main className="flex-1 container mx-auto px-4 py-20 flex flex-col items-center text-center space-y-12 relative z-10">
        ...
        <div className="space-y-6 flex flex-col items-center max-w-4xl mx-auto">
          ...
          <div className="animate-slide-up-fade opacity-0" style={{ animationDelay: '0ms', animationFillMode: 'forwards' }}>
            <p className="text-lg md:text-xl text-red-600 dark:text-red-400 font-semibold tracking-wide">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-6xl mt-20 text-left">
          <Card className="hover:shadow-lg transition-all duration-300 group border-border">
            <CardHeader>
      ...
      <footer className="border-t py-12 bg-muted/40 dark:bg-muted/20 relative z-10">
